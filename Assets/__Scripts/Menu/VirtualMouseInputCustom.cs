...
namespace UnityEngine.InputSystem.UI
{
    ...
    /// <seealso cref="Mouse"/>
    [AddComponentMenu("Input/Virtual Mouse Custom")]
    public class VirtualMouseInputCustom : MonoBehaviour
    {
        /// <summary>
        ...
        // private void SyncSystemMouse() {
        //     m_VirtualMouse.WarpCursorPosition(m_SystemMouse.position.ReadValue());
        // }

        private Vector2 lastSystemMousePosition = Vector2.zero;
        ...
        private void UpdateMotion()
        {
            ...
            var stickStopped = Mathf.Approximately(0, stickValue.x) && Mathf.Approximately(0, stickValue.y);
            if (stickStopped)
            {
                // Motion has stopped.
                m_LastTime = default;
                ...
                // System mouse moved since last stick input
