...
namespace RainbowArt
{
    ...
    public class SliderRangeTransition : UIBehaviour, IDragHandler, IInitializePotentialDragHandler, ICanvasElement,IPointerDownHandler
    {
        ...
        public Text text1; 
        public Text text2; 
        public Animator animatorHandle1; 
        public Animator animatorHandle2; 
        ...
        public RangedSliderTransitionEvent onValue1Changed = new RangedSliderTransitionEvent();
        public RangedSliderTransitionEvent onValue2Changed = new RangedSliderTransitionEvent();
